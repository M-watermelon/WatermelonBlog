...
When starting PicoCTF, I recommend familiarizing with the different types of categories (think of them like genres) in the competition (these terms are also often used in general computer science):
- General topics
...
### Conclusion
Cybersecurity and programming aren't easy. There is a learning curve that depends on you. It might be steep and you might be bombarded by tons of technical terms or you might breeze through it, everyone's different. Sometimes you  might get stumped on PicoCTF challenges or some problem in your program and it could get frustrating, but nothing is more satisfying than that final eureka moment. Also cybersecurity and programming, computer science in general, is going to require math. Depending on the person, that might be a good thing or a bad thing. This isn't new, math is essential for much of science and even daily life. But one thing to keep in mind is that effort always pays out in the end!
